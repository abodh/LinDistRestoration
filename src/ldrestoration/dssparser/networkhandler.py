...
class NetworkHandler:
    ...
    def __init__(
        ...
        pdelements_data: Optional[list[dict[str, Union[int, str, float, npt.NDArray[np.complex128]]]]] = None,
    ) -> None:
    ...
    def __network_input_validator(self) -> None:
        ...
        if self.pdelements_data is None and self.pdelement_handler is None:
            logger.warning(
                "You need to provide either one of the following: pcelement list of dicts or PCElementHandler"
            )
    ...
    def build_network(
        self,
        all_pdelements: list[dict[str, Union[int, str, float, npt.NDArray[np.complex128]]]],
